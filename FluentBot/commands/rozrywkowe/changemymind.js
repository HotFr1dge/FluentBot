...
module.exports = {
    name: "changemymind",
    category: "rozrywkowe",
    description: "Generuje mema changemymind.",
    usage: "<tekst>",
    run: async (client, message, args) => {
        ...
        .get(encodeURI(`https://nekobot.xyz/api/imagegen?type=changemymind&text=${args.join(" ")}`)).catch(() => {
        ...
        const embed = new RichEmbed()
        .setAuthor(`CHANGE MY MIND`, `https://fluentbot.pl/img/fun.png`)
        .setColor('#166ee8')
        .setTimestamp()
