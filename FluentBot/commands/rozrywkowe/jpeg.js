...
module.exports = {
    name: "jpeg",
    category: "rozrywkowe",
    description: "Rozpikselowuje zdjęcie i pogarsza jego jakość.",
    ...
    run: async (client, message, args) => {
        ...
        .get(encodeURI(`https://nekobot.xyz/api/imagegen?type=jpeg&url=${target}`)).catch(() => {
        ...
        const embed = new RichEmbed()
        .setAuthor(`JPEG`, `https://fluentbot.pl/img/fun.png`)
        .setColor('#166ee8')
        .setTimestamp()
