...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        DabiClient.custom.do("https://www.pornpics.com/ass/", /https:\/\/img\.pornpics\.com\/[0-9]{3}\/[0-9]{4}-[0-9]{2}-[0-9]{2}\/[0-9]{6}_[0-9]{2}\.jpg/gm).then(matches => {
            let random = Math.floor(Math.random() * matches.length)
    
            const embed = new RichEmbed()
            .setAuthor(`ASS`, `https://fluentbot.pl/img/nsfw.png`)
            .setColor("#ff4055")
            .setTimestamp()
